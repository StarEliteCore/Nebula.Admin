...
namespace Destiny.Core.Flow.IdentityServer.ResponseHandling
{
    public class AuthorizeInteractionResponseBaseGenerator : IAuthorizeInteractionResponseGenerator
    {
        /// <summary>
        /// The logger.
        /// </summary>
        ...
        public AuthorizeInteractionResponseBaseGenerator(
            ISystemClock clock,
