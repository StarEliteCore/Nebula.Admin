...
namespace Destiny.Core.Flow
{
    public static class FindFluentSortBy<TEntity, TProjection>
    {
        ...
        public static IOrderedFindFluent<TEntity, TProjection> OrderBy(IFindFluent<TEntity, TProjection> findFluent, string propertyName, Flow.Enums.SortDirection sortDirection)
        {
