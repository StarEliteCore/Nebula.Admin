...
using Destiny.Core.Flow.OpenIddictServer.ViewModels.Account;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Identity;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.Rendering;

namespace Destiny.Core.Flow.OpenIddictServer.Controllers
{
    [Authorize]
  public class AccountController : Controller
  {
    ...
    private readonly OpenIddictEntityDefaultDbContext _applicationDbContext;
    ...
    public AccountController(
        ...
        OpenIddictEntityDefaultDbContext applicationDbContext)
    {
    ...
    public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
    {
      ...
      if (ModelState.IsValid)
      {
        var user = new User { UserName = model.Email, Email = model.Email, NickName = model.Email };
