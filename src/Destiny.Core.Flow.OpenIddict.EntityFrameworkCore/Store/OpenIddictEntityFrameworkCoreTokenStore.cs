...
namespace Destiny.Core.Flow.OpenIddict.EntityFrameworkCore.Store
{
    ...
    //    OpenIddictEntityFrameworkCoreTokenStore<Token,
    //                                            Application,
    //                                            Authorization, TContext, Guid>
    ...
    public class OpenIddictEntityFrameworkCoreTokenStore<TContext, TKey> :
        OpenIddictEntityFrameworkCoreTokenStore<TokenBase<TKey>,
                                                ApplicationBase<TKey>,
                                                AuthorizationBase<TKey>, TContext, TKey>
        where TContext : DbContext
        ...
        where TKey : notnull, IEquatable<TKey>
    {
        ...
        public virtual ValueTask<DateTimeOffset?> GetCreationDateAsync(TToken token, CancellationToken cancellationToken)
        {
            ...
            return new ValueTask<DateTimeOffset?>(DateTime.SpecifyKind(token.CreatedTime, DateTimeKind.Utc));
        }
        ...
        public virtual ValueTask SetCreationDateAsync(TToken token, DateTimeOffset? date, CancellationToken cancellationToken)
        {
            ...
            token.CreatedTime = date?.UtcDateTime ?? default;
