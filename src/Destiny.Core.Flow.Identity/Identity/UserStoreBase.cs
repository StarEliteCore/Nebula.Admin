...
namespace Destiny.Core.Flow.Identity
{
...

    {
        ...
        /// <returns>
        /// The <see cref="T:System.Threading.Tasks.Task"/> that represents the asynchronous
        /// operation, containing the user matching the specified <paramref name="userId"/> if it exists.
        /// </returns>
        ...
        /// <returns>
        /// The <see cref="T:System.Threading.Tasks.Task"/> that represents the asynchronous
        /// operation, containing the user matching the specified <paramref
        /// name="normalizedUserName"/> if it exists.
        /// </returns>
        ...
        /// <param name="login">
        /// The external <see cref="T:Microsoft.AspNetCore.Identity.UserLoginInfo"/> to add to the
        /// specified <paramref name="user"/>.
        /// </param>
        /// <param name="cancellationToken">
        /// The <see cref="T:System.Threading.CancellationToken"/> used to propagate notifications
        ...
        /// <summary>
        /// Attempts to remove the provided login information from the specified <paramref
        /// name="user"/>. and returns a flag indicating whether the removal succeed or not.
        /// </summary>
        ...
        public Task<TUser> FindByLoginAsync(string loginProvider, string providerKey, CancellationToken cancellationToken)
        {
            ...
            TUserKey userId = _userLoginRepository.Entities.Where(m => m.LoginProvider == loginProvider && m.ProviderKey == providerKey)
        ...
        /// <param name="claims">
        /// The collection of <see cref="T:System.Security.Claims.Claim"/> s to add.
        /// </param>
        /// <param name="cancellationToken">
        /// The <see cref="T:System.Threading.CancellationToken"/> used to propagate notifications
        /// that the operation should be canceled.
        ...
        /// <param name="newClaim">
        /// The new claim to replace the existing <paramref name="claim"/> with.
        /// </param>
        /// <param name="cancellationToken">
        /// The <see cref="T:System.Threading.CancellationToken"/> used to propagate notifications
        /// that the operation should be canceled.
        ...
        public Task ReplaceClaimAsync(TUser user, Claim claim, Claim newClaim, CancellationToken cancellationToken)
        {
            ...
            List<TUserClaim> userClaims = _userClaimRepository.Entities.Where(m => m.UserId.Equals(user.Id) && m.ClaimType == claim.Type && m.ClaimValue == claim.Value).ToList();
        ...
        /// <param name="claims">
        /// A collection of <see cref="T:System.Security.Claims.Claim"/> s to remove.
        /// </param>
        /// <param name="cancellationToken">
        /// The <see cref="T:System.Threading.CancellationToken"/> used to propagate notifications
        /// that the operation should be canceled.
        ...
        /// <summary>
        /// Gets a flag indicating whether the email address for the specified <paramref
        /// name="user"/> has been verified, true if the email address is verified otherwise false.
        /// </summary>
        ...
        /// whether the email address for the specified <paramref name="user"/> has been confirmed
        /// or not.
        /// </returns>
        ...
        /// A flag indicating if the email address has been confirmed, true if the address is
        ...
        /// The normalized email to set for the specified <paramref name="user"/>.
        /// </param>
        /// <param name="cancellationToken">
        /// The <see cref="T:System.Threading.CancellationToken"/> used to propagate notifications
        /// that the operation should be canceled.
        ...
        /// The <see cref="T:System.DateTimeOffset"/> after which the <paramref name="user"/>'s
        /// lockout should end.
        /// </param>
        /// <param name="cancellationToken">
        /// The <see cref="T:System.Threading.CancellationToken"/> used to propagate notifications
        ...
        /// <param name="enabled">
        /// A flag indicating if lock out can be enabled for the specified <paramref name="user"/>.
        /// </param>
        /// <param name="cancellationToken">
        /// The <see cref="T:System.Threading.CancellationToken"/> used to propagate notifications
        /// that the operation should be canceled.
        ...
        /// </param>
        /// <param name="enabled">
        /// A flag indicating whether the specified <paramref name="user"/> has two factor
        ...
        /// <returns>
        /// The <see cref="T:System.Threading.Tasks.Task"/> that represents the asynchronous
        /// operation, containing a flag indicating whether the specified <paramref name="user"/>
        ...
        public async Task SetTokenAsync(TUser user, string loginProvider, string name, string value, CancellationToken cancellationToken)
        {
            ...
            TUserToken token = _userTokenRepository.Entities
        ...
        /// <returns>
        /// An instance of <typeparamref name="TUserKey"/> representing the provided <paramref name="id"/>.
        /// </returns>
